...
ENV JAVA_FOLDER_NAME jdk1.8.0_162
ENV JAVA_TAR_GZ_NAME jdk-8u162-linux-x64.tar.gz
ENV JDK_HOME /usr/java/${JAVA_FOLDER_NAME}
ENV JAVA_HOME /usr/java/${JAVA_FOLDER_NAME}/jre
ENV JAVA_OPTS -Dfile.encoding=UTF-8

#使用在线下载JDK进行构建-请修改为自己的地址
ENV JDK_DOWNLOAD_URL https://www.sgaop.com/news/static/docker/${JAVA_TAR_GZ_NAME}
